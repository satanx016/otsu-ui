...
return function()
  local mappings_tb = {}
  require("otsu.cheatsheet").organize_mappings(mappings_tb)

  vim.g.nv_previous_buf = vim.api.nvim_get_current_buf()
  local buf = api.nvim_create_buf(false, true)

  local win = require("otsu.cheatsheet").getLargestWin()
  ...
  require("otsu.utils").set_cleanbuf_opts "nvcheatsheet"

  vim.keymap.set("n", "<ESC>", function()
    require("otsu.tabufline").close_buffer(buf)
  end, { buffer = buf })
end
