...
---@class HLGroups
---@field nvUpdaterTitleFAIL Base46HLGroups # highlight group for otsu_updater
---@field nvUpdaterTitleDone Base46HLGroups # highlight group for otsu_updater
---@field nvUpdaterTitle Base46HLGroups # highlight group for otsu_updater
---@field nvUpdaterProgressFAIL Base46HLGroups # highlight group for otsu_updater
---@field nvUpdaterProgressDONE Base46HLGroups # highlight group for otsu_updater
---@field nvUpdaterProgress Base46HLGroups # highlight group for otsu_updater
---@field nvUpdaterFAIL Base46HLGroups # highlight group for otsu_updater
---@field nvUpdaterCommits Base46HLGroups # highlight group for otsu_updater
