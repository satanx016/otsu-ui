...
--- List of extras themes for other plugins not in Otsu that you want to compile
...
--- Separator style for Otsu Statusline
...
---Options for Otsu/ui lsp configuration
---@class NvLspConfig
