...
---     - If a function, then the second argument of the function are the list of key sequences that defined the loading of this plugin by Otsu 
...
--- If `opts` is a function, then the second argument `opts` is the default config defined by Otsu 
...
--- - If a function, then the second argument of the function are the list of event(s) that defined the loading of this plugin by Otsu (if any)
---     - The first argument is reserved for internal use, it should not be used under normal circumstances
---
...
--- By default, all Otsu plugins have `lazy = true`, meaning it will not be loaded unless
...
--- By default, all Otsu plugins has `lazy = true`, which means it will not be loaded automatically 
